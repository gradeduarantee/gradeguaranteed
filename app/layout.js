...
export const metadata = {
  ...
  title: {
    default: 'GradeGuaranteed.com â Take My Online Class For Me | A or B Guaranteed',
  ...
  openGraph: {
    ...
    title: 'GradeGuaranteed.com â Take My Online Class For Me | A or B Guaranteed',
  ...
  twitter: {
    ...
    title: 'GradeGuaranteed.com â Take My Online Class For Me',
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <body>
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-VEMXDZX0QP"
